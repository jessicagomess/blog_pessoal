...
public class BasicSecurityConfig {
	...
	@Bean // Define a service principal que a Security utiliza
	UserDetailsService userDetailsService() {
		return new UserDetailsServiceImpl();
	}

	@Bean // Define o códificador de senha
	...
	@Bean // Método onde todas as requisições serão tratadas e filtradas de acordo com as Config. do authFilter e da Basic Security
